package co.mbwa.lugus.web.rest;

import static co.mbwa.lugus.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import co.mbwa.lugus.LugusApp;
import co.mbwa.lugus.config.Constants;
import co.mbwa.lugus.domain.User;
import co.mbwa.lugus.repository.AuthorityRepository;
import co.mbwa.lugus.repository.UserRepository;
import co.mbwa.lugus.security.AuthoritiesConstants;
import co.mbwa.lugus.service.UserService;
import co.mbwa.lugus.service.dto.PasswordChangeDTO;
import co.mbwa.lugus.service.dto.UserDTO;
import co.mbwa.lugus.web.rest.vm.KeyAndPasswordVM;
import co.mbwa.lugus.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = LugusApp.class)
