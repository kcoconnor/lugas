...
public class UserResourceIT {
    ...
    /**
     * This repository is mocked in the co.mbwa.lugus.repository.search test package.
     *
     * @see co.mbwa.lugus.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
